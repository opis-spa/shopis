...
// material
import { Grid, Button, Link, Typography, Stack, TextField, Divider } from '@mui/material';
// hooks
import usePartnership from '../../../hooks/usePartnership';
// redux
import { useDispatch, useSelector } from '../../../redux/store';
import { onNextStep, applyShipping, createBilling, createInformation } from '../../../redux/slices/product';
// components
...
const CheckoutInformation = () => {
  ...
  const { handleSubmit, setFieldValue, touched, errors, values, getFieldProps } = formik;
    ...
    <FormikProvider value={formik}>
      <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
        ...
        <Grid item xs={12}>
          ...
          <CheckoutDelivery formik={formik} onApplyShipping={handleApplyShipping} deliveryOptions={DELIVERY_OPTIONS} />
